...
const Footer = () => {
  return (
    <>
      {/* <footer className="footer footer-center bg-[#1E1E1E] text-white rounded p-10 relative top-[555px]">
        <nav className="grid grid-flow-col gap-4">
          <a className="link link-hover">Home</a>
          <a className="link link-hover">About us</a>
          <a className="link link-hover">Centers</a>
          <a className="link link-hover">Student's Affairs</a>
        </nav>
        <div>
      ...
      <footer className="footer bg-[#1E1E1E] text-white p-10 relative top-[555px] ">
        <aside>
