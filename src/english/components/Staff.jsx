        ...
        <section class=" text-content-base">
          <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
              ...
              <a
                href="/english/staff"
                class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#1E1E1E] rounded-lg hover:bg-[#637C65] focus:ring-4 focus:outline-none focus:ring-blue-300 hidden md:inline-flex"
              >
                See All Staff
                <svg
            ...
            <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
              <div class="items-center bg-[#293b1f]/20 rounded-lg shadow sm:flex ">
                ...
                <div class="p-5">
                  ...
                  <span class="text-sm">CEO & Web Developer</span>
              ...
              <div class="items-center bg-[#293b1f]/20 rounded-lg shadow sm:flex ">
                ...
                <div class="p-5">
                  ...
                  <span class="">Senior Front-end Developer</span>
                  <p class="mt-3 mb-4 font-light ">
              ...
              <div class="items-center bg-[#293b1f]/20 rounded-lg shadow sm:flex">
                ...
                <div class="p-5">
                  ...
                  <span class="">Marketing & Sale</span>
                  <p class="mt-3 mb-4 font-light">
